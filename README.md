...
3. inspect Coverage Lint for dead or never-selected fixtures, empty slots, and per-stage pool collapse;
4. use Explain diagnostics when a candidate is unexpectedly excluded or not selected;
5. for engine changes, verify deterministic behavior and JSON-order invariance.
