...
export function runCompilerSmokeTests() {
  ...
  assert(prompt.includes('anatomy=[vagina, mouth, hands]'), 'character physical constraints missing', failures);
  ...
  assert(noAnchor.includes('沒有可用的 Main Anchor；不要自行捏造新的核心玩法。'), 'missing-anchor guard text missing', failures);
